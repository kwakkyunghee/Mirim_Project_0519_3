package kr.hs.emirims2117.mirim_project_0519_3;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rg.setOnCheckedChangeListener(rhListener);
    ...
    RadioGroup.OnCheckedChangeListener rhListener=new RadioGroup.OnCheckedChangeListener() {
        @Override
